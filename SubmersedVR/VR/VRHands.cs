...
namespace SubmersedVR
{
    ...
    class VRHands : MonoBehaviour
    {
        ...
        {
            HandOffsets.PDA.Apply(rightTarget);
        }
        ...
        internal void OnToolEquipped(PlayerTool tool)
        {
            ...
            tool.GetHandOffset().Apply(leftTarget.transform);
        }
    }
    ...
    public static class Aiming
    {
        ...
        {
            return VRCameraRig.instance?.laserPointerLeft.eventCamera;
        }
