...
namespace SubmersedVR
{
    ...
    static class HandOffsets
    {
        ...
        public static TransformOffset RightHandLeftHandedMode = new TransformOffset(new Vector3(-0.05f, 0.06f, -0.17f), new Vector3(40.0f, -175.0f, -270.0f));
        public static TransformOffset LeftHandLeftHandedMode = new TransformOffset(new Vector3(0.05f, 0.06f, -0.17f), new Vector3(-40.0f, 0.0f, -90.0f));
        public static TransformOffset PDALeftHandedMode = new TransformOffset(new Vector3(0.05f, 0.05f, -0.14f), new Vector3(305.0f, -355.0f, -100.0f));
        ...
        internal static TransformOffset GetHandOffset(this PlayerTool tool)
        {
            if (Settings.LeftHandAsMainHand)
            {
                switch (tool)
                {
                    ...
                    default: return RightHandLeftHandedMode;
                };
            }
            switch (tool)
            {
    ...
    class VRHands : MonoBehaviour
    {
        ...
        public void Setup(FullBodyBipedIK ik)
        {
            ...
            */
            ...
            Settings.LeftHandAsMainHandChanged += _ =>
            {
                MirrorHands();
            };
        }
        ...
        public void ResetHandTargets()
        {
            if (Settings.LeftHandAsMainHand)
            {
                HandOffsets.LeftHandLeftHandedMode.Apply(leftTarget);
                HandOffsets.RightHandLeftHandedMode.Apply(rightTarget);
            }
            else
            {
        ...
        public void OnOpenPDA()
        {
            if (Settings.LeftHandAsMainHand)
            {
                HandOffsets.PDALeftHandedMode.Apply(leftTarget);
            }
            else
            {
        ...
        {
            Vector3 rightHandScale = rightHand.localScale;
            rightHand.localScale = new Vector3(-rightHandScale.x, rightHandScale.y, rightHandScale.z);

            Vector3 leftHandScale = leftHand.localScale;
            leftHand.localScale = new Vector3(-leftHandScale.x, leftHandScale.y, leftHandScale.z);
        }
    }
    ...
    // This configures the hands offset for the PDA
